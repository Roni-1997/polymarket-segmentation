...
| `btc5m_cohorts_6m_2026-03-10_09-09.json` | `scripts/btc5m/grid_from_features.py` | Seven-cohort grid and v2 over the whole March 10 to September 9 period and per calendar month, one cohort per wallet per window, with persistence bands, gain concentration and a daily series. Source for the six-month section of `docs/btc5m_cohorts_pnl.md`. |
