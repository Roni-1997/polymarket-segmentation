-- Cohort × category × side breakdown (30d), 7-cohort framework.
--
...
--   touched_vol_musd — maker + taker
--
-- Use case: distinguish who PROVIDES liquidity vs who CONSUMES it
-- within each category. The touched/aggregate view in
